...
Automatically activate scanning for:
- New dependencies with known CVEs or security vulnerabilities
- Exposed credentials, API keys, or secrets in code
...
For comprehensive security analysis, use extended reasoning when encountering:
